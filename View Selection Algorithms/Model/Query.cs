namespace View_Selection_Algorithms.Model
{
    public class Query
    {
        ...
        public List<Tuple<string, string>> WhereCondition { get; set; }
        ...
        public Query(int queryNumber,double queryFrequency, List<Tuple<string, string, string>> join, List<Tuple<string, string>> whereCondition, List<Tuple<string, string>> projectionColumn, List<string> baseRelation, List<Tuple<string, string>> queryProjectionColumn)
        {
